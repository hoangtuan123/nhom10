...
{if isset($smarty.get.validation)}
	<div class="conf confirm" style="width: 710px; margin: 0 auto;">
		{l s='Your Sitemaps were successfully created. Please do not forget to setup the url' mod='gsitemap'} <a href="{$gsitemap_store_url|escape:'htmlall':'UTF-8'}sitemap.xml" target="_blank"><span style="text-decoration: underline;">{$gsitemap_store_url|escape:'htmlall':'UTF-8'}sitemap.xml</a></span> {l s='in your Google Webmaster account' mod='gsitemap'}.
</div>
<br/>
{/if}
...
{else}
	{if $gsitemap_links}
		<fieldset style="width: 700px; margin: 0 auto;">
			...
			<a href="{$gsitemap_store_url|escape:'htmlall':'UTF-8'}sitemap.xml" target="_blank"><span style="color: blue;">{$gsitemap_store_url|escape:'htmlall':'UTF-8'}sitemap.xml</span></a><br/><br/>
