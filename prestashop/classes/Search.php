...
class SearchCore
{
		...
		$order_way = 'desc', $ajax = false, $use_cookie = true, Context $context = null)
	{
		...
		if ($ajax)
		{
			$sql = 'SELECT DISTINCT p.id_product id_product,p.reference preference,im.id_image image, pl.name pname, cl.name cname,p.price pprice, cl.link_rewrite crewrite, pl.link_rewrite prewrite '.$score.'
